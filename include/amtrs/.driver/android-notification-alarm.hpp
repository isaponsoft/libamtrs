...
#include "../java/java/lang/Class.hpp"
...
public:
	...
	virtual void add_alarm(const alarm& _notificate) override
	{
		AlarmReceiver::find().addAlarm(
			...
			java::jobj<String>(java::to_jstring(_notificate.groupId)),
			java::jobj<String>(java::to_jstring(_notificate.groupTitle)),
			_notificate.wakeup ? 1 : 0
		);
	}
