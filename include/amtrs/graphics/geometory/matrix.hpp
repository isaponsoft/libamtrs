...
#ifndef	__libamtrs__graphics__geometory__matrix__hpp
#define	__libamtrs__graphics__geometory__matrix__hpp
#include "vec.hpp"
...
struct	matrix_tag
{
	...
	using	vector_tag_type	= AMTRS_IMPLEMENTS(vec)::vector_tag<col_size>;
};
...
constexpr auto operator * (const AMTRS_IMPLEMENTS(vec)::_vector_impliments<LVT, LTag, LCT>& _vec, const _matrix_impliments<RVT, RTag, RCT>& _mtx) noexcept
{
...
#if 0
template<class LVT, class LTag, class LCT, class RVT, class RTag, class RCT>
auto operator * (const AMTRS_IMPLEMENTS(vec)::_vector_impliments<LVT, LTag, LCT>& _vec, const _matrix_impliments<RVT, RTag, RCT>& _mtx) noexcept
{
	using	vec_type	= typename _vector_impliments<LVT, LTag, LCT>::vector_type;
	using	mat_type	= typename _matrix_impliments<RVT, RTag, RCT>::matrix_type;
	vec_type	retval	= vec_type::zero();
...
struct	mat33 : _matrix_impliments<T, matrix_tag<3, 3>, mat33<T>>
{
	...
	value_type		_11 l _12 l _13;
	value_type		_21 l _22 l _23;
	value_type		_31 l _32 l _33;
...
struct	mat44 : _matrix_impliments<T, matrix_tag<4, 4>, mat44<T>>
{
	...
	value_type		_11 l _12 l _13 l _14;
	value_type		_21 l _22 l _23 l _24;
	value_type		_31 l _32 l _33 l _34;
	value_type		_41 l _42 l _43 l _44;
	...
	constexpr mat44(const mat33<value_type>& _m) noexcept
		: mat44(_m._11 l _m._12 l _m._13 l 0,
		        _m._21 l _m._22 l _m._23 l 0,
		        _m._31 l _m._32 l _m._33 l 0,
		        0      l  0     l 0      l 1)
	{}
...
private:
	...
	constexpr MatrixT& mul(R&& _rhs, typename std::enable_if<std::is_base_of<AMTRS_IMPLEMENTS(vec)::vector_tag<RCOL>, R>::value>::type* = 0)
	{
