...
#ifndef	__libamtrs__graphics__geometory__size__hpp
#define	__libamtrs__graphics__geometory__size__hpp
#include "vec.hpp"
AMTRS_GRAPHICS_NAMESPACE_BEGIN


template<class T>
struct	size2 : AMTRS_IMPLEMENTS(vec)::vector_tag<2>
{
	using	value_type	= T;
...
template<class T>
struct	size3 : AMTRS_IMPLEMENTS(vec)::vector_tag<3>
{
	using	value_type	= T;
