...
public:
	...
	void initialize(pipeline::instance_type* _pipeline, vkref<VkDevice> const& _device, vkref<VkPipelineCache> const& _cache)
	{
		...
		// マテリアルの初期化
		shader_layout	layout	= mOwner->mat.layout();
	...
	vkref<VkPipeline> const& pipeline(vkref<VkRenderPass> _renderpass, VkExtent2D _viewsize, renderstate const* _currentstate)
	{
