...
#ifndef	__libamtrs__g3d__vulkan__g3d_vulkan__hpp
#define	__libamtrs__g3d__vulkan__g3d_vulkan__hpp
#include "../../../amtrs.hpp"
...
#define	_AMTRS_VKINVOKE_R(_func, _falie)	\
			...
			{\
				...
				if (vklasterr)\
				{\
					AMTRS_WARN_LOG(#_func ": {}", std::to_string(vklasterr).c_str());\
					return	_falie;\
				}\
			} else {\
				_func;\
...
#include "g3d-vulkan-api-to_string.hpp"
