...
template<class ImageT, class T, class Traits>
std::basic_ostream<T, Traits>& operator << (std::basic_ostream<T, Traits>& _out, bmp<ImageT> _bmp)
{
...
template<class ImageT, class T, class Traits>
std::basic_istream<T, Traits>& operator >> (std::basic_istream<T, Traits>& _in, bmp<ImageT> _bmp)
{
