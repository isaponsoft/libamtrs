#ifndef	__libamtrs__graphics__opengl__vertex_memory__hpp
#define	__libamtrs__graphics__opengl__vertex_memory__hpp
...
public:
	...
	{
		ref<vertex_memory>	thiz	= new vertex_memory();
		_resources->set(thiz);
	...
	{
		vertex_memory*	thiz	= static_cast<vertex_memory*>(_vtx->get_memory());
