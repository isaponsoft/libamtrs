...
#include <amtrs/graphics/g3d/vulkan/g3d-vulkan-api-function_list.hpp>
...
void vkdevice::execute(ref<commandlist> _commands)
{
	...
	for (;;)
	{
		...
		mGraphics->next_image(false);
		if (vklasterr.good())
		{
			break;
		}

	    if (vklasterr == VK_ERROR_OUT_OF_DATE_KHR || vklasterr == VK_ERROR_SURFACE_LOST_KHR)
		{
			clean();
			continue;
		}
